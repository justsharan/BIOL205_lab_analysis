...
kbl(worm_data.stats, caption = "Descriptive statistics for the glyphosate experiment data", 
...
Taken from UBCO BIOL 202 Lab Tutorials:
...
Since the P-value for this test is greater than $\alpha = 0.05$ ($0.452 >> 0.05$), there is no evidence against the null hypothesis of equal variance.
